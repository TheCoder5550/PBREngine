...
export default function TreeHandler(scene, camera, treePath = [
  "../../assets/models/trees/myFirstTree/myFirstTree.glb",
  "../../assets/models/trees/myFirstTreeObj/myFirstTreeImposter.glb",  
], levels = [
  30,
  Infinity,
]) {
  // if (treePaths.length !== levels.length) {
  //   throw new Error("Mismatched levels and paths");
  // }
